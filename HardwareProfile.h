...
//	#endif
    ...
    #define RF_INT_PIN      PORTBbits.RB9
    #define RF_INT_TRIS     TRISBbits.TRISB9
      
    #define USE_EXTERNAL_EEPROM
           
    // Transceiver Configuration

	#define PHY_CS              LATAbits.LATA8 
	#define PHY_CS_TRIS         TRISAbits.TRISA8 
	...
	#define EE_nCS_TRIS         TRISBbits.TRISB8
	#define EE_nCS              LATBbits.LATB8
